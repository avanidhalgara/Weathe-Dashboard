...
$(document).ready(function() {
  ...
  function searchWeather(searchValue) {
    ...
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/weather?q=" + searchValue + "&appid=da404cd66ec5927f8fd89078dc9a5b24&units=imperial",
      dataType: "json",
  ...
  function getForecast(searchValue) {
    ...
    $.ajax({
      ...
      url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=da404cd66ec5927f8fd89078dc9a5b24&units=imperial",
      dataType: "json",
      success: function(data) {
  ...
  function getUVIndex(lat, lon) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/uvi?appid=da404cd66ec5927f8fd89078dc9a5b24&lat=" + lat + "&lon=" + lon,
      dataType: "json",
      success: function(data) {
